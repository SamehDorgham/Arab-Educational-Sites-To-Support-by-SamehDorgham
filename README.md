...
### [1] مقالات باللغة العربية
 #### هندسة البرمجيات - لغة بايثون - علم وتحليل البيانات - تعلم الآلة والتعلم العميق - الذكاء الاصطناعي
 

### 1- اقرأ‑تِك 👋 ... نتناول هندسة البرمجيات بالعربية 🚀

منصة عربية تهدف لإثراء المحتوي التقني
من خلال تناول كل ما يخص هندسة البرمجيات باللغة العربية
وتشجيع الجميع علي القراءة والتعلم
...
#### https://eqraatech.com
...
 #### 2- بايثون - موقع هرمش :
 ...
 #### 4- الذكاء الاصطناعي بالعربي :
 #### https://aiinarabic.com
 #### 5- التعلم العميق بالعربي :
 #### https://dlarabic.com
...
#### https://www.youtube.com/@7adid_elsafina/
 #### 18- علم وتحليل البيانات - م.أحمد علي :
#### https://www.youtube.com/@ahmedali-friendlyanalysis7283
#### 19- علم وتحليل البيانات - م.محمد العسال :
...
#### 22- قناة علم وتحليل البيانات - م.آلاء عصام
#### https://www.youtube.com/@alaaessam6189
#### 23- برمجة - الذكاء الاصطناعي - قواعد البيانات - د.عادل صبور
#### https://www.youtube.com/@AdelSabour/playlists
#### 24- الداتا مع براء Data with Baraa ... م.براء الخطيب سالكيني
#### https://www.youtube.com/@DataWithBaraa
#### 25- تعلم تحليل البيانات ... ElSearshgy - السيرشجى ... م.محمد تحسين
#### https://www.youtube.com/@Elsearshgy
...
#### 1- الأتمتة بالذكاء الاصطناعي + N8N ... د.محمد الشامي
...
### [11] كل ما يخص العمل الحر - الفريلانسينج Freelance

#### كل ما يخص العمل الحر - د.أحمد السباعي

#### https://www.youtube.com/@AhmedElSebaey1


-------------------------------------------------------------------------------------------------------

### [12] تعلم اللغة الإنجليزية من الصفر للإحتراف - ZAmericanEnglish
...
### [13] بدائل عربية رائعة يجب دعمها
 #### بدائل عربية رائعة يجب دعمها 

 #### 1- منصة قبيلة - { ... qabilah ... } : 
 #### أفضل بديل عربي لمنصة لينكدان موجه للعرب - منصة المحترفين العرب 
 #### https://qabilah.com
 #### 2- منصة في كونكت - { ... vconnct ... } :
 #### أفضل بديل عربي لمنصة زووم وجوجل ميت - منصة أونلاين ميتنج عربية
 #### https://vconnct.me/ar/home

 #### 3- منصة مرتكز { ... mortakaz ... } 
#### لكـل فكــرة بدايـة .. ولكـل بدايــة مرتكـز
#### منصة تمنح المطورين ورواد الأعمال العرب مساحة لعرض أعمالهم مباشرة أمام مجتمع مهتم بالتقنية والابتكار، مع إبراز المشاريع المميزة عبر تفاعل المجتمع ودعمه لها.

#### https://www.mortakaz.com
